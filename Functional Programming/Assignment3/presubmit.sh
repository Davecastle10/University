...
if [ "$1" = "" ]
then
    echo "You forgot to add the assignment name: 'Assignment3'."
...
then
    ...
    echo -e "\t(i) your file is called 'Assignment3.hs'"
...
toRose = Assignment3.toRose

fromRose :: Rose a -> Free [] a
fromRose = Assignment3.fromRose

{- Question 2 -}

trace :: FreeState s a -> State ([s],s) a
trace = Assignment3.trace

{- Question 3 -}

roundRobin :: [YieldState s ()] -> State s ()
roundRobin = Assignment3.roundRobin

{- Question 4 -}

schedule :: [SleepState s ()] -> State s ()
schedule = Assignment3.schedule
