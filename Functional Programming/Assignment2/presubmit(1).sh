...
if [ "$1" = "" ]
then
    echo "You forgot to add the assignment name: 'Assignment2'."
...
then
    ...
    echo -e "\t(i) your file is called 'Assignment2.hs'"
...
encodeWord = Assignment2.encodeWord

encodeWords :: Table -> [String] -> Code
encodeWords = Assignment2.encodeWords

encodeText :: Table -> String -> Code
encodeText = Assignment2.encodeText


{- Question 2 -}
decodeText :: Table -> Code -> String
decodeText = Assignment2.decodeText


{- Question 3 -}
decodeTextWithTree :: Tree -> Code-> String
decodeTextWithTree = Assignment2.decodeTextWithTree


{- Question 4 -}
ramify :: Table -> Tree
ramify = Assignment2.ramify


{- Question 5 -}
tabulate :: Tree -> Table
tabulate = Assignment2.tabulate


{- Question 6 -}
tree :: String -> Maybe Bracket
tree = Assignment2.tree
